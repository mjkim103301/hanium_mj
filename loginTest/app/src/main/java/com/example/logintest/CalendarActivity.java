...
public class CalendarActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private void getResultsFromApi() {
        ...
        Log.d("@@@@", "!sGooglePlayServicesAvailable() : "+ !isGooglePlayServicesAvailable());
        Log.d("@@@@", "mCredential.getSelectedAccountName() == null : "+ (mCredential.getSelectedAccountName() == null));
        Log.d("@@@@", "!isDeviceOnline() : "+ !isDeviceOnline());
