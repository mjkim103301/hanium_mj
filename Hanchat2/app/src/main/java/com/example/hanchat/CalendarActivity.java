...
public class CalendarActivity extends NavActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent_profile = new Intent(CalendarActivity.this, ProfileActivity.class);
...
//     3. 안드로이드 디바이스에서 인터넷 사용 가능          isDeviceOnline()
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private MakeRequestTask(CalendarActivity activity, GoogleAccountCredential credential) {
            mActivity = activity;
